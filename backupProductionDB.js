...
async function backupToLocal() {
  try {
    ...
    const prodConnection = await mongoose.createConnection('mongodb://localhost:27017/', {
    ...
    const localConnection = await mongoose.createConnection('mongodb://mongo:XZzxFWnpbsNcVoXUHNeleDgtpeVuaQVG@autorack.proxy.rlwy.net:49856/', {
      useNewUrlParser: true,
      useUnifiedTopology: true
    });
